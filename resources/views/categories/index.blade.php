<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <button 
                ...
                class="bg-red-400 dark:bg-blue-900 hover:bg-blue-200 text-white hover:text-white dark:text-white dark:hover:bg-blue-700 py-2 px-4 rounded">
                Tambah Kategori
            </button>
        </div>
    </x-slot>
    ...
    <main class="container mx-auto mt-6 px-4">
        <table class="table-auto w-full bg-white border dark:bg-gray-400 border-gray-200 rounded-lg shadow-md">
            <thead class="bg-red-400 dark:bg-gray-700 text-white">
                <tr>
